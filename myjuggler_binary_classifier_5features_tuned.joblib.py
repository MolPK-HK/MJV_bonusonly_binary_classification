...
PAYOUT_BIG_GROSS = 242      # BIGボーナス1回あたりの総獲得枚数
PAYOUT_REG_GROSS = 98       # REGボーナス1回あたりの総獲得枚数
...
# ★★★ 学習済みモデルのファイルパスを指定 ★★★
MODEL_FILE_PATH = 'myjuggler_binary_classifier_5features_tuned.joblib' # ご自身のモデルファイル名に変更
